...
class xlsx_hlp:
    ...
    filtername = ""
    filename = ""
    filepath = "os.path.join(xlsx_hlp.folder_name,xlsx_hlp.filename+filtername)"
    current = ""
    ws_main = None
    ...
    def create_wb(filtername=""):
        ...
        if not os.path.isfile(os.path.join(xlsx_hlp.folder_name,xlsx_hlp.filename+filtername)+".xlsx"):
            xlsx_hlp.current = os.path.join(os.path.join(xlsx_hlp.folder_name,xlsx_hlp.filename+filtername)+".xlsx")
        else:
            i = 1
